...
const ResignationDialog = ({ DialogData, leave_approval_id }) => {
    ...
    const rawDate = DialogData?.apply_date;
        ...
        <div>
            {leave_approval_id ? (
                <Box sx={{ p: 1 }}>
                    <Grid container spacing={0} sx={{ border: '1px solid #E4E4E4', m: -0.7 }}>
                        <Grid item xs={3} sx={{ border: '1px solid #E4E4E4', p: 1 }}>
                            <Box sx={{ display: "flex", alignItems: 'center' }}>
                                <Typography variant="subtitle1" color="initial" fontWeight={600} sx={{ width: '100px' }}>Resignation ID:</Typography>
                        ...
                        <Grid item xs={5} sx={{ border: '1px solid #E4E4E4', p: 1 }}>
                            <Box sx={{ display: "flex", alignItems: 'center' }}>
                                <Typography variant="subtitle1" color="initial" fontWeight={600} sx={{ width: '100px' }}>Resignation Type:</Typography>
                        ...
                        <Grid item xs={3} sx={{ border: '1px solid #E4E4E4', p: 1 }}>
                            <Box sx={{ display: "flex", alignItems: 'center' }}>
                                ...
                                <Typography variant="subtitle1" color="initial" >{new Date(leave_id_data?.results?.[0]?.apply_date).toLocaleDateString("en-GB")}</Typography>
                            </Box>
                        </Grid>
                        <Grid item xs={5} sx={{ border: '1px solid #E4E4E4', p: 1 }}>
                            <Box sx={{ display: "flex", alignItems: 'center' }}>
                        ...
                        <Grid item xs={4} sx={{ border: '1px solid #E4E4E4, p: 1' }}>
                            <Box sx={{ display: "flex", alignItems: 'center', }}>
                                <Typography variant="subtitle1" color="initial" fontWeight={600} sx={{ width: '150px' }}>Status:</Typography>
                        ...
                        <Grid item xs={12} sx={{ border: '1px solid #E4E4E4', py: 2, px: 1 }}>
                            <Box sx={{ display: "flex", flexDirection: "column", mt: -2 }}>
                                <Typography variant="subtitle1" color="initial" fontWeight={600} sx={{ width: '100px', pt:1 }}>Reason:</Typography>
                    ...
                    <Box>
                        <Typography variant="h6" color="initial" sx={{ mt: 2 }}>Approvals Status:</Typography>
                                ...
                                <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls={`panel${index + 1}-content`} id={`panel${index + 1}-header`}>
                                    <Box sx={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                        ...
                                        <Box sx={{ width: '50%', display: 'flex', justifyContent: 'end', mr: 2 }}>
                                            Approval Date: {DialogData?.approved_date}
                                        </Box>
                                    </Box>
                                </AccordionSummary>
                                <AccordionDetails>
                ...
                <Box sx={{ p: 1 }}>
                    <Grid container spacing={0} sx={{ border: '1px solid #E4E4E4', m: -0.7 }}>
                        <Grid item xs={3} sx={{ border: '1px solid #E4E4E4', p: 1 }}>
                            <Box sx={{ display: "flex", alignItems: 'center' }}>
                                <Typography variant="subtitle1" color="initial" fontWeight={600} sx={{ width: '110px' }}>Resignation ID:</Typography>
                                <Typography variant="subtitle1" color="initial" >#01120</Typography>
                            </Box>
                        </Grid>
                        <Grid item xs={5} sx={{ border: '1px solid #E4E4E4', p: 1 }}>
                            <Box sx={{ display: "flex", alignItems: 'center' }}>
                                <Typography variant="subtitle1" color="initial" fontWeight={600} sx={{ width: '140px' }}>Resignation Type:</Typography>
                        ...
                        <Grid item xs={5} sx={{ border: '1px solid #E4E4E4', p: 1 }}>
                            <Box sx={{ display: "flex", alignItems: 'center' }}>
                                <Typography variant="subtitle1" color="initial" fontWeight={600} sx={{ width: '100px' }}>Effective Date:</Typography>
                                <Typography variant="subtitle1" color="initial" >{new Date(DialogData?.from_date).toLocaleDateString('en-GB')}<span style={{ fontWeight: 600 }}> TO</span> {DialogData?.to_date}</Typography>
                            </Box>
                        </Grid>
                        <Grid item xs={4} sx={{ border: '1px solid #E4E4E4', p: 1 }}>
                            <Box sx={{ display: "flex", alignItems: 'center', }}>
                        ...
                        <Grid item xs={12} sx={{ border: '1px solid #E4E4E4', py: 2, px: 1 }}>
                            <Box sx={{ display: "flex", flexDirection: "column", mt: -2 }}>
                                <Typography variant="subtitle1" color="initial" fontWeight={600} sx={{ width: '200px' , pt:1}}>Reason:</Typography>
                                <Typography variant="subtitle1" color="initial" >
                                    {DialogData?.notes}
                                </Typography>
                            </Box>
