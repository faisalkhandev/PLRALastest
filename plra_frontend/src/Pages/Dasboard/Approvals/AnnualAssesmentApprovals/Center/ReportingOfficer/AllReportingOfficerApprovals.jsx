...
import { useCoroAllApprovalsQuery, useCorohistoryAllApprovalsQuery, } from "../../../../../../Features/API/AnnualAssessment";
import CenterDialog from "../CenterDialog";


const AllReportingOfficerApprovals = () => {
  ...
  console.log(user_id);
  const {data: pendingData,isLoading: pendingLoading,isError: PendingisError,error: Pendingerror,refetch: pendingRefetch,} = useCoroAllApprovalsQuery(user_id);
  console.log("pendingData", pendingData);
  const {data: historyData,isLoading: historyLoading,isError: historyisError,error: historyerror,refetch: historyRefetch,} = useCorohistoryAllApprovalsQuery(user_id);
  ...
  const pendingcolumns = [
    {
      ...
      renderCell: (params) => {
        return <Link to={`/approval/annualassesment/${params?.row?.id}/cro_approval/${params?.row?.processid}`} style={{ color: "#379237", textDecoration: "underline" }}>
...
export default AllReportingOfficerApprovals;
