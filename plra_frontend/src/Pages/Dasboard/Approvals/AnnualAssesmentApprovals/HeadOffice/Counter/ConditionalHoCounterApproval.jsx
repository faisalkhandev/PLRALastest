...
import MiniDashboardHeadOffice from '../MiniDashboardHeadOffice.jsx'
...
const ConditionalHoCounterApproval = () => {
  ...
  const handleCasualClick = (label) => {
    ...
    console.log(`Casual mini card clicked with label by: ${label}`);
  };
...
export default ConditionalHoCounterApproval
