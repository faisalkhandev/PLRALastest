...
const HeadOfficeDialog = ({ DialogData }) => {
      ...
      <Box sx={{ pl: 1.5 }}>
        {DialogData?.results[0]?.status === "Completed" && (
          <Box sx={{ display: "flex", justifyContent: "end", alignItems: "center", mb: 2, pr: 1 }}>
            <Link to={`/AnnualAssessment/${DialogData?.results?.[0]?.id}`}>
        ...
        <Grid container spacing={0} sx={{ border: "1px solid #E4E4E4", m: -0.7 }}>
          ...
          <Grid item xs={12} sx={{ border: "1px solid #E4E4E4", py: 2, px: 1 }}>
            <Box sx={{ display: "flex", flexDirection: "column", mt: -2 }}>
              ...
              <Typography variant="subtitle1" color="initial">
                {DialogData?.results[0]?.brief_achievements}
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={12} sx={{ border: "1px solid #E4E4E4", py: 2, px: 1 }}>
        ...
        <Box>
          <Typography variant="h6" color="initial" sx={{ mt: 2, mb: 1 }}> Approvals:</Typography>
