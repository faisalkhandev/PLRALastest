...
const Super_leave_approvals = () => {
    ...
    return (
        <Box sx={{ p: 1 }}>
            <Grid container spacing={0} sx={{ border: '1px solid #E4E4E4', m: -0.7 }}>
                ...
                <Grid item xs={4} sx={{ border: '1px solid #E4E4E4', p: 1 }}>
                    <Box sx={{ display: "flex", alignItems: 'center', justifyContent: 'space-between' }}>
                        <Typography variant="subtitle1" color="initial" fontWeight={600} sx={{ width: '100px' }}>Attechment:</Typography>
                        <Box sx={{ display: "flex", alignItems: 'center' }}>
                            <Box sx={{ fontWeight: 600, px: 2, pt: 0.4, borderRadius: "4px", backgroundColor: theme.palette.success[300], color: theme.palette.success[600], mr: 2, cursor: 'pointer' }} onClick={openPdfInNewTab}>
                                <Outlined_eye color={`${theme.palette.success[600]}`} />
                            </Box>
                            <Box sx={{ fontWeight: 600, px: 2, pt: 0.4, backgroundColor: theme.palette.success[300], color: theme.palette.success[600], borderRadius: "4px", cursor: 'pointer' }}>
                                <Download />
                            </Box>
                        </Box>
                    </Box>
            ...
            {/* super approvals */}
            <>
                <Typography variant="h6" color="initial" sx={{ my: 2 }}>Super Approvals:</Typography>
                {leaveData?.results[0]?.superapprovals.map((data, index) => (
                    <Accordion key={index} sx={{ p: 1, }}>
                        <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls={`super-panel${index + 1}-content`} id={`super-panel${index + 1}-header`}>
                            <Box sx={{ width: '50%', display: 'flex', alignItems: 'center', gap: 2 }}>
                                <Typography variant="subtitle1" color="initial" sx={{ fontWeight: 600 }}>{data?.approving_authority?.first_name} {data?.approving_authority?.last_name}</Typography>
                                <Typography variant="subtitle1" color="initial" sx={{ fontWeight: 600 }}>|</Typography>
                                <Typography variant="subtitle1" sx={{
                                    fontWeight: 600,
                                    px: 2,
                        ...
                        <Box sx={{ display: "flex", alignItems: 'start', flexDirection: "column", px: 2 }}>
                            ...
                            <Box sx={{ width: "100%", display: "flex", alignItems: 'start', mt: 2 }}>
...
export default Super_leave_approvals
