...
const MiniDashboardResignationDetailPage = ({ fillter, onCasualClick }) => {
    ...
    <>
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog}>
        <Box sx={{ width: '800px', p: 2, height: "70vh", overflow: 'scroll' }}>
          ...
          <TerminationDialog DialogData={selectedRecord} />
        </Box>
      </Dialog>
    </>
  );
...
export default MiniDashboardResignationDetailPage;
