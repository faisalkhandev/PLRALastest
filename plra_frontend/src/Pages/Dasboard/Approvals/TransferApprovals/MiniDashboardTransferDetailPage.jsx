...
const MiniDashboardTransferDetail = ({ onCasualClick, leaveId }) => {
        ...
        <Box sx={{}}>
            ...
            <Typography variant="h5" color="initial"
                sx={{
                    ...
                    mt: 1, fontWeight: 600
                }}> {`${employeeData?.results[0]?.employee_id.title?.employee_title || ''}${employeeData?.results[0]?.employee_id?.first_name || ''} ${employeeData?.results[0]?.employee_id?.last_name || ''}`}</Typography>
            <Box sx={{
...
export default MiniDashboardTransferDetail;
