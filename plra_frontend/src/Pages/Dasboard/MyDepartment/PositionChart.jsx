...
import optionsData from '../../../Data/Charts/Position.json'; // Assuming the correct path
    ...
    return (
        <Card sx={{ height: "370px", width: '100%', backgroundColor: '#fff', color: '#000', borderLeft: '2px solid', boxShadow: "0px 2px 4px rgba(0, 0, 0, 0.1)", borderBottom: '2px solid', borderColor: theme.palette.primary.main }}>
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', p: 2 }}>
                <Typography variant="body1" color="initial" sx={{ width: 'auto', fontWeight: 600, fontSize: '18px' }}>Positions</Typography>
                <Typography variant="body1" color="initial" sx={{ width: 'auto', fontSize: '18px' }}> <span style={{ fontSize: '12px', color: 'gray' }}>Total:</span> 300</Typography>
            </Box>
