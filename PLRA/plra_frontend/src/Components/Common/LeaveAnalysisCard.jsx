...
const LeaveAnalysisCard = () => {
    ...
    return (
        <Box className="employee_form_dashboard" sx={{ height: "calc(100vh - 150px)" }}  >
            {/* Image  */}
            <Box className="employee_form_dashboard_Img" sx={{ width: "200px", height: '200px', overflow: 'hidden', objectFit: 'cover' }}><img src={team} alt="" /></Box>
            ...
            <Grid container spacing={2} sx={{ mt: -2 }}>
                <Grid item xs={4}>
                    <Box className="employee_form_dashboard_detail_box">
                        <Typography variant="h5" color="initial" sx={{ fontWeight: 600 }}>0</Typography>
                        <Typography variant="h6" color="initial">Casual</Typography>
                    </Box>
                </Grid>
                <Grid item xs={4}>
                    <Box className="employee_form_dashboard_detail_box">
                        <Typography variant="h5" color="initial" sx={{ fontWeight: 600 }}>0</Typography>
                        <Typography variant="h6" color="initial">Earned</Typography>
                    </Box>
                </Grid>
                <Grid item xs={4}>
                    <Box className="employee_form_dashboard_detail_box">
                        <Typography variant="h5" color="initial" sx={{ fontWeight: 600 }}>0</Typography>
                        <Typography variant="h6" color="initial">Medical</Typography>
                    </Box>
                </Grid>
                <Grid item xs={4}>
                    <Box className="employee_form_dashboard_detail_box">
