...
function Prob_Officer({ selectedEmployee, setSelectedEmployee,setDisabledNext,selectedEmployeeName,setSelectedEmployeeNames  }) {
...
const renderCheckbox = (params) => {
    ...
    const handleCheckboxChange = useCallback((params, e) => {
        ...
        if (e.target.checked) {
            ...
            setSelectedEmployee({
                ...selectedEmployee,
                prob_officer: params.row.id // Update the employee ID in the state
            });
            const employeeName = `${params.row.first_name} ${params.row.last_name}`;
            setSelectedEmployeeNames({
                ...selectedEmployeeName,
                prob_officer_name: employeeName // Update the employee ID in the state
            });
            ...
            setSelectedEmployee({
                ...selectedEmployee,
                prob_officer: '' // Clear the employee ID when the checkbox is unchecked
            });
        }
    }, []);
    ...
    useEffect(() => {
        const isEmployeeSelected = !!selectedEmployee.prob_officer;
        setDisabledNext(!isEmployeeSelected);
        setSelectedEmployeeIds(selectedEmployee.prob_officer ? [selectedEmployee.prob_officer] : []);
    }, [selectedEmployee.prob_officer])
