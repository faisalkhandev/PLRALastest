...
const MiniDashboardLeaveDetail = () => {
    const theme = useTheme();

    const { data: superApprovalData, isLoading: superApprovalLoading, isError: superApprovalError, refetch } = useGetSuperApprovalApiQuery();
                ...
                <Box
                    ...
                    <Box sx={{
                        ...
                        {records.map(record => (
                            <Link
                                key={record.id}
                                to={`/approval/superapproval/${record.id}/approval/${record.leave_request_id}`}
                                style={{
                                    padding: "4px 0",
                                    width: "100%",
                                    color: '#000',
