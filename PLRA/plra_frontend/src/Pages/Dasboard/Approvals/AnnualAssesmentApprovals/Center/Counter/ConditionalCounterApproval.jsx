  ...
  return (
    <div>
      <Box sx={{ display: 'flex', alignItems: 'center', }}>
        ...
        <Breadcrumb title="Countersigning Officer Approval" breadcrumbItem="Approvals / Countersigning Officer Approval" />
      </Box>
      ...
      <Grid container spacing={3} >
        ...
        <Grid item xs={3}>
          <Box sx={{ border: `1px solid ${theme.palette.gray[100]}`, p: 0.5, borderRadius: '4px', height: 'calc(100vh - 200px)', maxWidth: '100%', overflow: 'scroll' }}>
            <MiniDashboardCenter onCasualClick={handleCasualClick} leaveId={counterData?.results[0]?.employee?.id} />
          </Box>
        </Grid>
      </Grid>
    </div>
