...
import { useApprovalsByIdQuery, useApprovalsleavePutMutation } from '../../../../Features/API/SetupApi.js';
...
const ApprovalDetail = () => {
    ...
    const [ApprovalsPut] = useApprovalsleavePutMutation();

    useEffect(() => { leaverefectch(); }, [leaverefectch]);
    ...
    const status = leaveData?.results[0]?.status;
    ...
    return (
        <Box sx={{}}>
                            ...
                            <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", }}>
                                ...
                                <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                                    <Box sx={{ fontWeight: 600, px: 2, pt: 0.4, borderRadius: "4px", backgroundColor: theme.palette.success[300], color: theme.palette.success[600], cursor: "pointer", }}>
                                        <div onClick={() => { openPdfInNewTab(leaveData?.results[0]?.attachment) }}>
            ...
            <Box sx={{ m: 0.7 }}>
                <Typography variant="h6" color="initial" sx={{ mt: 2, mb: 1, fontWeight: 600, pl: 0.6 }}>Alternate Approvals:</Typography>
