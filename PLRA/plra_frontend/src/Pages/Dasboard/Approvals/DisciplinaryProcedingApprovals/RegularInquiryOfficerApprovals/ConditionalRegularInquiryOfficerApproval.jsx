...
const ConditionalRegularInquiryOfficerApproval = () => {
      ...
      <Grid container spacing={3} >
        ...
        <Grid item xs={3}>
          <Box sx={{ border: `1px solid ${theme.palette.gray[100]}`, p: 0.5, borderRadius: '4px', height: 'calc(100vh - 200px)', maxWidth: '100%', overflow: 'scroll' }}>
            <MiniDashboardDisciplineProceedingsDetail onCasualClick={handleCasualClick} leaveId={DisciplineProceedingsData?.employee?.id} />
          </Box>
        </Grid>
      </Grid>
    </div>
...
export default ConditionalRegularInquiryOfficerApproval
