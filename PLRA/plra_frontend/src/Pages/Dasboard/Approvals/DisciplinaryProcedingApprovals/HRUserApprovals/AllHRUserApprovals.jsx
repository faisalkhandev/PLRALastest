...
import { useAllHRUserHistoryApprovalQuery, useAllHRUserPendingApprovalQuery } from "../../../../../Features/API/DisciplinaryProceedings";
import DisciplinaryProcedingDialog from "../DisciplinaryProcedingDialog";
import { gridCellStyle } from "../../../../../Utils/cellstyle";

const AllHRUserApprovals = () => {
  ...
  console.log(user_id);
  const { data: pendingData, isLoading: pendingLoading, isError: PendingisError, error: Pendingerror, refetch: pendingRefetch, } = useAllHRUserPendingApprovalQuery(user_id);
  console.log("pendingData", pendingData);
  const { data: historyData, isLoading: historyLoading, isError: historyisError, error: historyerror, refetch: historyRefetch, } = useAllHRUserHistoryApprovalQuery(user_id);
  ...
  const pendingcolumns = [
    {
      ...
      renderCell: (params) => {
        return <Link to={`/approval/hruserapproval/${params?.row?.id}/hruserapproval/${params?.row?.processid}`} style={{ color: "#379237", textDecoration: "underline" }}>
    ...
    <div>
      <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", }}>
        <Box sx={{ display: "flex", alignItems: "center" }}>
          ...
          <Breadcrumb title="HR User Approvals" breadcrumbItem="Approvals / HR User Approvals" />
        </Box>
...
export default AllHRUserApprovals;
